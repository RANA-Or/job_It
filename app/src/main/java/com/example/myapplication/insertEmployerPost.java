...
public class insertEmployerPost extends AppCompatActivity {
    ...
    private void addDatatoFirebase(String title, String description, String skills, String salary, String date, String timeNow, String location, String contactName, String email) {
